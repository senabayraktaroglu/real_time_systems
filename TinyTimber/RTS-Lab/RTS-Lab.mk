...
$(IntermediateDirectory)/sioTinyTimber.c$(ObjectSuffix): sioTinyTimber.c
	...
	$(CC) $(SourceSwitch) "Z:/RTS-LAB-git/real_time_systems/TinyTimber/RTS-Lab/sioTinyTimber.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/sioTinyTimber.c$(ObjectSuffix) $(IncludePath)
